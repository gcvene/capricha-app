...
$lang['thank_you_for_appointment'] = 'Obrigado por agendar um horário conosco. Abaixo seguem os detalhes. Para alterações, acesse o link.';
...
$lang['disable_sync'] = 'Desabilitar sincronização';
...
$lang['about_app'] = 'Sobre o Capricha';
...
$lang['about_app_info'] = 'Capricha é uma plataforma de agendamento online feita para barbearias. Permite que seus clientes marquem horários pela internet e envia lembretes automáticos por WhatsApp para reduzir faltas.';
$lang['current_version'] = 'Versão atual';
$lang['support'] = 'Suporte';
$lang['about_app_support'] = 'Se encontrar algum problema ao usar o Capricha, entre em contato pelo WhatsApp ou pelo e-mail de suporte.';
...
$lang['about_app_license'] = 'Capricha é baseado no Easy!Appointments, licenciado sob a licença GPLv3. Ao utilizar este software de qualquer forma, você concorda com os termos descritos na seguinte URL:';
...
$lang['ea_update_success'] = 'Capricha foi atualizado com sucesso.';
...
$lang['api_token_hint'] = 'Defina um token secreto para habilitar a autenticação baseada em token da API do Capricha.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'A API permite interagir com todos os dados do Capricha via protocolo HTTP e criar suas próprias integrações.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Esta integração permite conectar-se a um servidor LDAP existente e importar automaticamente usuários para o Capricha, permitindo SSO com a senha do diretório (o nome de usuário deve corresponder).';
$lang['host'] = 'Host';
$lang['port'] = 'Porta';
